#3700567241722602805502
#1854402128504779378109
#9326759566356089486360
#3772387490080804971144
#4099750035705181220318
...
# UUID = "731695e035724fa5947821e02e89b750"
...
class Trgbt:
    def __init__(self, pipe, keybind, fov, hsv_range, shooting_rate, fps):
        ...
        self.Fov = (
            ...
            int(self.HEIGHT / 2 - 10*self.size),
            int((self.WIDTH + self.size)/2),
            int(self.HEIGHT / 2 - 1),
        )
...
#6543596097809210043973
#3367217709674638597443
#8863657821753356346104
#1685942091773635511514
#6565489590326702646947
